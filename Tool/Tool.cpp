...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	ON_BN_CLICKED(IDC_BUTTON3, &CAboutDlg::OnBnClickedDelete)
	ON_LBN_SELCHANGE(IDC_IMAGE_LIST, &CAboutDlg::OnLbnSelchangeImageList)
END_MESSAGE_MAP()
...
void CAboutDlg::OnBnClickedDelete()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}


void CAboutDlg::OnLbnSelchangeImageList()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}
