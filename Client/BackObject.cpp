...
#include "ScrollMgr.h"
CBackObject::CBackObject() : m_fAngle(0.f)
{															
}															
...
void CBackObject::MiniRender()
{
	...
	D3DXMatrixTranslation(&matTrans,
		vPos.x * Size - CScrollMgr::GetScrollPos().x,
		vPos.y * Size - CScrollMgr::GetScrollPos().y,
		vPos.z);
...
void CBackObject::LineRender()
{
	...
	//오브젝트 테두리
	m_vConvert[0] = { vPos.x - fCenterX - CScrollMgr::GetScrollPos().x, vPos.y - fCenterY - CScrollMgr::GetScrollPos().y, 0.f };
	m_vConvert[1] = { vPos.x - fCenterX - CScrollMgr::GetScrollPos().x, vPos.y + fCenterY - CScrollMgr::GetScrollPos().y, 0.f };
	m_vConvert[2] = { vPos.x + fCenterX - CScrollMgr::GetScrollPos().x, vPos.y + fCenterY - CScrollMgr::GetScrollPos().y, 0.f };
	m_vConvert[3] = { vPos.x + fCenterX - CScrollMgr::GetScrollPos().x, vPos.y - fCenterY - CScrollMgr::GetScrollPos().y , 0.f };
